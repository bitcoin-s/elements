...
public:
    CMainParams(CScript scriptDestination) {
        ...
        scriptAlert = CScript() << CScript::EncodeOP_N(1) << ParseHex("0324a5c8922e33c0e66723450715864e1f641b8a37bea9bd3cdb6d6de56c81253e") << CScript::EncodeOP_N(1) << OP_CHECKMULTISIG;
        nDefaultPort = 8333;
